...
class User(Base):
    ...
    streak_last_date = Column(String, default="")
    daily_goal_date = Column(String, default="")
    daily_goal_errors_closed = Column(Integer, default=0)
    daily_goal_topics_done = Column(Integer, default=0)
    roadmap_topics_completed_total = Column(Integer, default=0)
    practice_sessions_completed = Column(Integer, default=0)
    mistake_training_sessions_completed = Column(Integer, default=0)
    chat_sessions_completed = Column(Integer, default=0)
    ai_explanations_completed = Column(Integer, default=0)
    ai_summaries_completed = Column(Integer, default=0)
    ai_quizzes_completed = Column(Integer, default=0)
    vocab_review_checked_count = Column(Integer, default=0)
    vocab_review_correct_count = Column(Integer, default=0)
    weekly_stats_key = Column(String, default="")
    weekly_roadmap_topics_done = Column(Integer, default=0)
    weekly_practice_sessions = Column(Integer, default=0)
    weekly_mistake_training_sessions = Column(Integer, default=0)
    weekly_chat_sessions = Column(Integer, default=0)
    weekly_ai_explanations = Column(Integer, default=0)
    weekly_ai_summaries = Column(Integer, default=0)
    weekly_ai_quizzes = Column(Integer, default=0)
    weekly_vocab_review_checked = Column(Integer, default=0)
    weekly_vocab_review_correct = Column(Integer, default=0)
    last_weekly_report_sent_date = Column(String, default="")
    words_per_day = Column(Integer, nullable=True)
    last_vocab_sent_date = Column(String, default="")
    last_vocab_review_sent_date = Column(String, default="")
